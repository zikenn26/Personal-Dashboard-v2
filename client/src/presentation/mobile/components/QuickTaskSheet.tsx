...
import { Plus, CheckSquare, Calendar, Tag } from 'lucide-react';
...
export const QuickTaskSheet: React.FC<QuickTaskSheetProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!cleanTitle || !onAddTodo) return;
  ...
  return (
    <BottomSheet isOpen={isOpen} onClose={onClose} title="Add New Task" subtitle="Create a quick to-do item">
